                ...
                <div class="col-md-4 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="card border-0 text-center features feature-clean">
                        ...
                        <div class="content mt-3">
                            ...
                            <p class="text-primary">{{ $setting['address'] ?? ''  }}</p>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="number" required type="tel" id="contact" class="form-control ps-5 @error('contact') is-invalid @enderror" placeholder="Contact No :">
                                                </div>
                                                @error('contact')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
