...
<div class="widget " style="margin-top: 60px;">
    <ul class="list-unstyled  sidebar-nav mb-0" id="navmenu-nav">
        <li class="navbar-item account-menu px-0 ">
            <a href="{{route('employee.dashboard')}}" class="navbar-link d-flex rounded shadow align-items-center py-2 px-4">
        ...
        <li class="navbar-item account-menu px-0 mt-2">
            <a href="{{route('employee.favorites')}}" class="navbar-link d-flex rounded shadow align-items-center py-2 px-4">
                <span class="h4 mb-0"><i class="uil uil-heart"></i></span>
                <h6 class="mb-0 ms-2">Favorite Jobs</h6>
            </a>
        </li>
        <li class="navbar-item account-menu px-0 mt-2">
            <a href="{{route('employee.follow')}}" class="navbar-link d-flex rounded shadow align-items-center py-2 px-4">
                <span class="h4 mb-0"><i class="uil uil-transaction"></i></span>
                <h6 class="mb-0 ms-2">Follow Companies</h6>
            </a>
        </li>
        <li class="navbar-item account-menu px-0 mt-2">
            <a href="{{route('employee.profile')}}" class="navbar-link d-flex rounded shadow align-items-center py-2 px-4">
