    ...
    <section class="page-users-view">
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Job Detail @if($job->is_featured==true) <span class="badge ml-2 badge-success">Featured</span> @endif</h4>
                        <div class="btn-group">
                            <a href="{{route('admin.job.edit',$job->slug)}}" class="btn btn-relief-secondary">Edit</a>
                            <a href="#" onclick="deleteAlert('{{route('admin.job.delete',$job->id)}}')" class="btn btn-relief-danger">Delete</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12  col-md-6 ">
                                <table class="ml-0 ml-sm-0 ml-lg-0">
                                    ...
                                    <tr>
                                        <td class="font-weight-bold">Job Level</td>
                                        <td> {{$job->job_level}}</td>
                                    </tr>
                                    @if($job->salary)
                                        <tr>
                            ...
                            <div class="col-sm-12 col-12">
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="font-weight-bold">Apply Link</td>
                                            <td class=""><a href="{{$job->link}}" target="_blank"> {{$job->link}}</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
